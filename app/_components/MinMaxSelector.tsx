    ...
    <div className='mt-[2px] ml-3 flex items-center max-h-6'>
      ...
      <div className='text-left w-full'>
        <input
          ...
          className='rounded xs:w-24 w-28 lg:w-20 xl:w-28 h-6 text-white mr-1 p-1 text-right max-h-6 mb-0 mt-0 bg-surface-sunken'
        />
        ...
        <input
          ...
          className='rounded xs:w-24 w-28 lg:w-20 xl:w-28 h-6 text-white p-1 text-right max-h-6 mb-0 mt-0 bg-surface-sunken'
        />
      </div>
    </div>
  )
